...
public class RouterDataSource implements DataSource {
  ...
  public RouterDataSource(Map<DataSource, Integer> dataSources) {
    this.dataSourceDelegates = ImmutableMap.<DataSource, Integer>builder().putAll(dataSources)
        .build();
  ...
  public void close() throws NoSuchMethodException, InvocationTargetException,
