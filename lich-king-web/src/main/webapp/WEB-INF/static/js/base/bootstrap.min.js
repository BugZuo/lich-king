...
+function (a) {
    ...
    d.VERSION = "3.3.4", d.TRANSITION_DURATION = 150, d.prototype.close = function (b) {
        ...
        b && b.preventDefault(), g.length || (g = e.closest(".alert")), g.trigger(
            ...
            "in"), a.support.transition && g.hasClass("fade") ? g.one("bsTransitionEnd",
    ...
    var c = function (b, c) {
        this.$element = a(b), this.$indicators =
            ...
            null, this.sliding = null, this.interval = null, this.$active = null, this.$items =
            null, this.options.keyboard && this.$element.on("keydown.bs.carousel",
                                                            a.proxy(this.keydown, this)), "hover"
                                                                                          == this.options.pause
                                                                                          && !("ontouchstart"
                                                                                               in document.documentElement)
                                                                                          && this.$element.on(
            "mouseenter.bs.carousel", a.proxy(this.pause, this)).on("mouseleave.bs.carousel",
    ...
    {interval: 5e3, pause: "hover", wrap: !0, keyboard: !0}, c.prototype.keydown = function (a) {
        ...
        return b || (this.paused = !1), this.interval && clearInterval(
            this.interval), this.options.interval && !this.paused && (this.interval =
        ...
        return b || (this.paused = !0), this.$element.find(".next, .prev").length
            ...
            a.support.transition.end), this.cycle(!0)), this.interval =
        ...
        if (this.$element.trigger(k), !k.isDefaultPrevented()) {
            ...
            return a.support.transition && this.$element.hasClass("slide") ? (f.addClass(
                ...
                c.TRANSITION_DURATION)) : (e.removeClass("active"), f.addClass(
    ...
    var d = function (b, c) {
        this.$element = a(b), this.options = a.extend({}, d.DEFAULTS, c), this.$trigger =
            ...
            null, this.options.parent ? this.$parent = this.getParent()
    ...
    {toggle: !0}, d.prototype.dimension = function () {
        ...
        return a(this.options.parent).find(
            '[data-toggle="collapse"][data-parent="' + this.options.parent + '"]').each(
    ...
    function b(b) {
        b && 3 === b.which || (a(e).remove(), a(f).each(function () {
            ...
            e.hasClass("open") && (e.trigger(
                b = a.Event("hide.bs.dropdown", f)), b.isDefaultPrevented() || (d.attr(
    ...
    g.VERSION = "3.3.4", g.prototype.toggle = function (d) {
        ...
        if (/(38|40|27|32)/.test(b.which) && !/input|textarea/i.test(b.target.tagName)) {
            ...
            if (b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled")) {
                ...
                var h = " li:not(.disabled):visible a", i = e.find(
    ...
    a.fn.dropdown = d, a.fn.dropdown.Constructor = g, a.fn.dropdown.noConflict = function () {
        ...
        "keydown.bs.dropdown.data-api", f, g.prototype.keydown).on("keydown.bs.dropdown.data-api",
                                                                   '[role="menu"]',
    ...
    var c = function (b, c) {
        this.options = c, this.$body = a(document.body), this.$element = a(b), this.$dialog =
            ...
            !1, this.options.remote && this.$element.find(".modal-content").load(
    ...
    c.VERSION = "3.3.4", c.TRANSITION_DURATION = 300, c.BACKDROP_TRANSITION_DURATION =
        ...
        this.isShown ? a(window).on("resize.bs.modal", a.proxy(this.handleUpdate, this)) : a(
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop =
                    a('<div class="modal-backdrop ' + e + '" />').appendTo(
            ...
            a.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(
                "bsTransitionEnd", g).emulateTransitionEnd(c.BACKDROP_TRANSITION_DURATION) : g()
        } else {
            b && b()
        }
    ...
    var c = function (a, b) {
        this.type = null, this.options = null, this.enabled = null, this.timeout =
            null, this.hoverState = null, this.$element = null, this.init("tooltip", a, b)
    };
    c.VERSION = "3.3.4", c.TRANSITION_DURATION = 150, c.DEFAULTS =
    {
        ...
        if (this.enabled = !0, this.type = b, this.$element = a(c), this.options =
                ...
                this.options.viewport && a(
                    this.options.viewport.selector || this.options.viewport), this.$element[0]
        ...
        return c && c.$tip && c.$tip.is(":visible") ? void(c.hoverState = "in") : (c || (c =
            new this.constructor(b.currentTarget, this.getDelegateOptions()), a(
            b.currentTarget).data("bs." + this.type, c)), clearTimeout(c.timeout), c.hoverState =
        ...
        var c = b instanceof this.constructor ? b : a(b.currentTarget).data("bs." + this.type);
        return c || (c = new this.constructor(b.currentTarget, this.getDelegateOptions()), a(
            b.currentTarget).data("bs." + this.type, c)), clearTimeout(c.timeout), c.hoverState =
        ...
        if (this.hasContent() && this.enabled) {
            ...
            j && (h = h.replace(i, "") || "top"), f.detach().css(
                {top: 0, left: 0, display: "block"}).addClass(h).data("bs." + this.type,
        ...
        return this.$element.trigger(g), g.isDefaultPrevented() ? void 0 : (f.removeClass(
            "in"), a.support.transition && f.hasClass("fade") ? f.one("bsTransitionEnd",
        ...
        b && (c = a(b.currentTarget).data("bs." + this.type), c || (c =
            new this.constructor(b.currentTarget, this.getDelegateOptions()), a(
            b.currentTarget).data("bs." + this.type, c))), c.tip().hasClass("in") ? c.leave(c)
            : c.enter(c)
    ...
    c.VERSION = "3.3.4", c.DEFAULTS =
        ...
        a.find(".popover-title")[this.options.html ? "html" : "text"](b), a.find(
            ".popover-content").children().detach().end()[this.options.html ? "string" == typeof c
    ...
    b.VERSION = "3.3.4", b.DEFAULTS = {offset: 10}, b.prototype.getScrollHeight = function () {
        ...
        this.offsets = [], this.targets = [], this.scrollHeight =
            this.getScrollHeight(), a.isWindow(this.$scrollElement[0]) || (c = "position", d =
    ...
    c.VERSION = "3.3.4", c.TRANSITION_DURATION = 150, c.prototype.show = function () {
        ...
        function f() {
            g.removeClass("active").find("> .dropdown-menu > .active").removeClass(
                ...
                "active").find('[data-toggle="tab"]').attr("aria-expanded", !0), h
                ? (b[0].offsetWidth, b.addClass("in")) : b.removeClass("fade"), b.parent(
                ".dropdown-menu").length && b.closest("li.dropdown").addClass("active").end().find(
                '[data-toggle="tab"]').attr("aria-expanded", !0), e && e()
        }

        var g = d.find("> .active"), h = e && a.support.transition && (g.length && g.hasClass(
                "fade") || !!d.find("> .fade").length);
    ...
    var c = function (b, d) {
        this.options = a.extend({}, c.DEFAULTS, d), this.$target =
            a(this.options.target).on("scroll.bs.affix.data-api",
                ...
                a.proxy(this.checkPositionWithEventLoop, this)), this.$element =
            a(b), this.affixed = null, this.unpin = null, this.pinnedOffset =
    ...
    {offset: 0, target: window}, c.prototype.getState = function (a, b, c, d) {
        ...
        if (this.$element.is(":visible")) {
            var b = this.$element.height(), d = this.options.offset, e = d.top, f = d.bottom, g = a(
            ...
            if (this.affixed != h) {
                ...
                this.affixed = h, this.unpin =
                    "bottom" == h ? this.getPinnedOffset() : null, this.$element.removeClass(
